    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=2019, max_length=200, verbose_name='Дата выхода')),
                ('country', models.CharField(max_length=100, verbose_name='Страна')),
                ('description', models.TextField(verbose_name='Описание')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name='Примьерав мире')),
                ...
                ('genres', models.ManyToManyField(to='movies.gener', verbose_name='Жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описан')),
                ('image', models.ImageField(upload_to='movies_shorts/', verbose_name='Изображение')),
